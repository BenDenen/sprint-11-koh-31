...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl("https://raw.githubusercontent.com/BenDenen/sprint-11-koh-31/")
            .addConverterFactory(
...
// https://raw.githubusercontent.com/BenDenen/sprint-11-koh-31/refs/heads/main/jsons/news_1.json
